  ...
  animations: [
    {
      ...
      events: [{ time: 0.5, type: "footstep", category: "audio", duration: 0.04, payload: { foot: "front" } }],
      tracks: [
        {
          id: "track.body.y",
...
test("compiles source project into deterministic compiled JSON v1", () => {
  ...
  assert.deepEqual(first.animations[0].events, [{ time: 0.5, type: "footstep", category: "audio", duration: 0.04, payload: { foot: "front" } }]);
