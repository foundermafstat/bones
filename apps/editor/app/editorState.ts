...
export const initialEditorProject: EditorProjectState = {
  ...
  poses: {
    ...
    fall_fast: { id: "fall_fast", name: "Fall fast", boneTransforms: { body: { x: 0, y: -268, rotation: 0.04, scaleX: 0.96, scaleY: 1.08 }, cloak: { x: -74, y: 4, rotation: -0.18, scaleX: 1, scaleY: 1 } }, tags: ["fall"] },
  ...
  animations: {
    ...
    walk: {
      ...
      tracks: {
        ...
        "cloak.rotation": [{ id: "walk-cloak-0", time: 0, value: 0.11, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "walk-cloak-1", time: 0.42, value: -0.08, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "walk-cloak-2", time: 0.84, value: 0.11, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }]
      }
    },
    jump: { id: "jump", name: "Jump", duration: 0.56, frameRate: 60, loop: false, events: [{ id: "jump-anticipation", time: 0.08, type: "anticipation" }, { id: "jump-liftoff", time: 0.12, type: "liftoff" }], markers: [{ id: "jump-compress", time: 0.1, label: "Compress", color: "#f97316" }, { id: "jump-peak", time: 0.56, label: "Peak", color: "#8b5cf6" }], tags: ["jump"], tracks: { "body.y": [{ id: "jump-body-y-0", time: 0, value: -248, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-body-y-1", time: 0.1, value: -242, interpolation: "bezier", curve: [0.4, 0, 0.8, 1] }, { id: "jump-body-y-2", time: 0.28, value: -272, interpolation: "bezier", curve: [0.1, 0.8, 0.2, 1] }, { id: "jump-body-y-3", time: 0.56, value: -294, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "body.rotation": [{ id: "jump-body-r-0", time: 0, value: 0.04, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-body-r-1", time: 0.1, value: -0.08, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-body-r-2", time: 0.56, value: -0.03, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "body.scaleX": [{ id: "jump-scale-x-0", time: 0, value: 1.02, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-scale-x-1", time: 0.1, value: 1.12, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-scale-x-2", time: 0.28, value: 0.94, interpolation: "bezier", curve: [0.1, 0.8, 0.2, 1] }, { id: "jump-scale-x-3", time: 0.56, value: 0.98, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "body.scaleY": [{ id: "jump-scale-y-0", time: 0, value: 0.98, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-scale-y-1", time: 0.1, value: 0.82, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-scale-y-2", time: 0.28, value: 1.16, interpolation: "bezier", curve: [0.1, 0.8, 0.2, 1] }, { id: "jump-scale-y-3", time: 0.56, value: 1.06, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "head.rotation": [{ id: "jump-head-0", time: 0, value: 0.08, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-head-1", time: 0.28, value: -0.06, interpolation: "bezier", curve: [0.1, 0.8, 0.2, 1] }, { id: "jump-head-2", time: 0.56, value: -0.02, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "upperArmFront.rotation": [{ id: "jump-arm-f-0", time: 0, value: -0.58, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-arm-f-1", time: 0.28, value: -1.05, interpolation: "bezier", curve: [0.1, 0.8, 0.2, 1] }, { id: "jump-arm-f-2", time: 0.56, value: -0.84, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "upperArmBack.rotation": [{ id: "jump-arm-b-0", time: 0, value: -0.48, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-arm-b-1", time: 0.28, value: -0.9, interpolation: "bezier", curve: [0.1, 0.8, 0.2, 1] }, { id: "jump-arm-b-2", time: 0.56, value: -0.72, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "thighFront.rotation": [{ id: "jump-thigh-f-0", time: 0, value: -0.18, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-thigh-f-1", time: 0.1, value: 0.28, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-thigh-f-2", time: 0.56, value: 0.42, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "shinFront.rotation": [{ id: "jump-shin-f-0", time: 0, value: 0.14, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-shin-f-1", time: 0.1, value: -0.32, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-shin-f-2", time: 0.56, value: -0.18, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "thighBack.rotation": [{ id: "jump-thigh-b-0", time: 0, value: 0.16, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-thigh-b-1", time: 0.1, value: -0.24, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-thigh-b-2", time: 0.56, value: 0.18, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "shinBack.rotation": [{ id: "jump-shin-b-0", time: 0, value: 0.18, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-shin-b-1", time: 0.1, value: 0.38, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-shin-b-2", time: 0.56, value: 0.22, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }], "cloak.rotation": [{ id: "jump-cloak-0", time: 0, value: -0.02, interpolation: "bezier", curve: [0.3, 0, 0.7, 1] }, { id: "jump-cloak-1", time: 0.28, value: -0.2, interpolation: "bezier", curve: [0.1, 0.8, 0.2, 1] }, { id: "jump-cloak-2", time: 0.56, value: -0.12, interpolation: "bezier", curve: [0.2, 0, 0.2, 1] }] } },
